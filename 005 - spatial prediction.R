...
plot_list = lapply(unique(pred_mat$var)[c(1:3,5:6,4)], function(var){
        print(var)
        rast = pred_rast_list[[which(pred_mat$var == var & pred_mat$quantile == 0.9)]]
